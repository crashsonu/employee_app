...
class MobileUpdateEmployeeView extends StatefulWidget {
  final EmployeeModel employee;

  const MobileUpdateEmployeeView({super.key, required this.employee});

  @override
  State<MobileUpdateEmployeeView> createState() => _CreateEmployeeState();
}

class _CreateEmployeeState extends State<MobileUpdateEmployeeView> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      child: const AppText(
                          text: 'Update Employee', color: Colors.white),
                    ),
                  ],
                ),
              ),
