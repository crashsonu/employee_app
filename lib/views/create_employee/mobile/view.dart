...
class MobileCreateEmployeeView extends StatefulWidget {
  const MobileCreateEmployeeView({super.key});

  @override
  State<MobileCreateEmployeeView> createState() => _CreateEmployeeState();
}

class _CreateEmployeeState extends State<MobileCreateEmployeeView> {
